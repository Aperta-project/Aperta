...
feature "Manuscript CSS", js: true do
  ...
  context "when editing the paper" do
    let(:paper) { FactoryGirl.create :paper, journal: journal, submitted: false, short_title: 'foo bar', creator: author }
  ...
  context "when the paper is submitted" do
    let(:paper) { FactoryGirl.create :paper, journal: journal, submitted: true, short_title: 'submitted foo bar', creator: author }
