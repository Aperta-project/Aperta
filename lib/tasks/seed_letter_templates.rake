  ...
  namespace :letter_templates do
    ...
    task populate: :environment do
      Journal.all.each do |journal|
        ...
        LetterTemplate.where(template_decision: 'reject', text: text, journal: journal).first_or_create!(to: to_field, subject: subject, letter: letter)
...
{{ manuscript.url }}
        ...
        subject = 'Your [JOURNAL NAME] submission'
        to_field = '[AUTHOR EMAIL]'
        LetterTemplate.where(template_decision: 'minor_revision', text: text, journal: journal).first_or_create!(to: to_field, subject: subject, letter: letter)
        ...
        subject = 'Your [JOURNAL NAME] submission'
        to_field = '[AUTHOR EMAIL]'
        LetterTemplate.where(template_decision: 'accept', text: text, journal: journal).first_or_create!(to: to_field, subject: subject, letter: letter)
      end
    end
  end
end
