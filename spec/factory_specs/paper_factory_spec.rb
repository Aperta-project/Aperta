...
# necessary setup.
#
# This spec was modified to fix a bug that did not appear until html
# sanitization was applied. In this spec paper.title was being set to
# an array object generated by Faker::Lorem.words. This is
# incorrect. paper.title shoud be a string value. Adding a call to the
# join method on the array object creates a string comprised of the
# generated words.
#
