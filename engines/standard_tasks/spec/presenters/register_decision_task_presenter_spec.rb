...
describe StandardTasks::RegisterDecisionTaskPresenter do
  ...
  describe "#data_attributes" do
    ...
    let(:task) do
      ...
      paper = Paper.create! title: "Foo bar",
        ...
        user: author,
        decision: 'Revise'
      task = StandardTasks::RegisterDecisionTask.create! completed: true,
    ...
    subject(:data_attributes) { StandardTasks::RegisterDecisionTaskPresenter.new(task).data_attributes }

    it_behaves_like "all tasks, which have common attributes" do
      let(:card_name) { 'standards-register-decision' }
