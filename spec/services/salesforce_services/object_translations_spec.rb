...
describe SalesforceServices::ObjectTranslations do
  ...
  def make_questions(paper)
    ...
    add_text_question_with_answer(paper,    'pfa_question_1b',         '100')
    add_boolean_question_with_answer(paper, 'pfa_question_2',          'Yes')
    add_text_question_with_answer(paper,    'pfa_question_2a',         'foo')
    add_text_question_with_answer(paper,    'pfa_question_2b',         '100')
    add_boolean_question_with_answer(paper, 'pfa_question_3',          'Yes')
    add_text_question_with_answer(paper,    'pfa_question_3a',         '100')
    add_boolean_question_with_answer(paper, 'pfa_question_4',          'Yes')
    add_text_question_with_answer(paper,    'pfa_question_4a',         '100')
    add_text_question_with_answer(paper,    'pfa_amount_to_pay',       '100')
