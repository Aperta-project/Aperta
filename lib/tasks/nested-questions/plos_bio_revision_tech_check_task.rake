namespace 'nested-questions:seed' do
  task 'plos-bio-revision-tech-check-task': :environment do
    ...
    questions << {
      ...
      value_type: "boolean",
      text: "For any resubmissions that have previously gone through review, ensure the authors have responded to the reviewer comments in the Revision Details box of the Response to Reviewers card. If this information is not present, request it from author.",
      position: 15
    }
