    ...
    unless LetterTemplate.exists?(journal: @journal, ident: ident)
      LetterTemplate.where(name: 'RA Accept', category: 'accept', journal: @journal).first_or_initialize.tap do |lt|
        ...
        lt.body = <<-TEXT.strip_heredoc
          ...
          <p>PRESS</p>
          <p>We frequently collaborate with communication and public information offices. If your institution is planning to promote your findings, we would be grateful if they could coordinate with [*INSERT EMAIL ADDRESS*].</p>
