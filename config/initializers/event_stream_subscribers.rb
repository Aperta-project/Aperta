...
Subscriptions.configure do
  ...
  add 'paper_role:created', StreamToPaperChannel, PaperRole::Created::EventStream::NotifyAssignee
  add 'paper_role:destroyed', StreamToEveryone, PaperRole::Destroyed::EventStream::NotifyAssignee
