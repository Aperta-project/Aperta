class DataMigrator::PlosBioRevisionTechCheckQuestionsMigrator < DataMigrator::Base
  TASK_OWNER_TYPE = "PlosBioTechCheck::RevisionTechCheckTask"

  IDENTS = {
    old: {
      OPEN_REJECTS_IDENT: "revision_tech_check.open_rejects",
      HUMAN_SUBJECTS_IDENT: "revision_tech_check.human_subjects",
      ETHICS_NEEDED_IDENT: "revision_tech_check.ethics_needed",
      DATA_AVAILABLE_IDENT: "revision_tech_check.data_available",
      SUPPORTING_INFORMATION_IDENT: "revision_tech_check.supporting_information",
      DRYAD_URL_IDENT: "revision_tech_check.dryad_url",
      FINANCIAL_DISCLOSURE_IDENT: "revision_tech_check.financial_disclosure",
      TOBACCO_IDENT: "revision_tech_check.tobacco",
      FIGURES_LEGIBLE_IDENT: "revision_tech_check.figures_legible",
      CITED_IDENT: "revision_tech_check.cited",
      COVER_LETTER_IDENT: "revision_tech_check.cover_letter",
      BILLING_INQUIRIES_IDENT: "revision_tech_check.billing_inquiries",
      ETHICS_STATEMENT_IDENT: "revision_tech_check.ethics_statement"
    },
  ...
  def verify_counts
    verify_count(
      expected: Question.where("ident LIKE 'revision_tech_check.%'").count - @subtract_from_expected_count,
