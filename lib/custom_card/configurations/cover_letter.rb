        ...
        <<-XML.strip_heredoc
          ...
          <card required-for-submission="true" workflow-display-only="false">
            <content content-type="display-children">
              ...
              <content ident="cover_letter--text" content-type="paragraph-input" value-type="html">
              ...
              <content ident="cover_letter--attachment" content-type="file-uploader" value-type="attachment" allow-multiple-uploads="true" allow-file-captions="true">
