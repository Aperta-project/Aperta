...
class InviteAECardTest(CommonTest):
    ...
    def test_smoke_invite_ae_card(self):
        """
        test_invite_ae: Validates the elements, styles, roles and functions of invite
        academic editors from new document creation through inviting ae, validation
        of the invite on the invitees dashboard, acceptance and rejections
        ...
        self.create_article(title='Test Invite Academic Editor', journal='PLOS Wombat',
        ...
        if invite_response == 'Accept':
            ...
            try:
                ...
                logging.info(
                    'Either the response reason, academic editor suggestions, or both are blank')
