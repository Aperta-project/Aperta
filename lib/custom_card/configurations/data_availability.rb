        ...
        <<-XML.strip_heredoc
          ...
          <card required-for-submission="false" workflow-display-only="false">
            <content content-type="display-children">
              ...
              <content content-type="question-list">
                <content content-type="text">
                  <text>
                    <![CDATA[<li class="question"><div class="question-text">Do the authors confirm that all the data underlying the findings described in their manuscript are fully available without restriction?</div></li>]]>
                  </text>
                  <content content-type="question-help-list">
                    <content content-type="text">
                      <text>
                ...
                <content content-type="text">
                  <text>
                    <![CDATA[<li class="question"><div class="question-text">Your answers should be entered into the box below and will be published in the form you provide them, if your manuscript is accepted. If you are copying our sample text below, please ensure you replace any instances of XXX with the appropriate details.</div></li>]]>
                  </text>
                  <content content-type="question-help-list">
                    <content content-type="text">
                ...
                <content content-type="text">
                  <text>
                    <![CDATA[<li class="question"><div class="question-text">Additional Data Availability information</div></li>]]>
                  </text>
                </content>
