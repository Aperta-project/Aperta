module Tahi
  class TaskGenerator < Rails::Generators::Base
    ...
    def get_user_info
      ...
      puts "If this is okay, press 'Enter', otherwise..."
      @path_name = ask("If you would you like to create your Engine in a different folder, specify the folder name here. (defaults to #{Rails.root}/#{default_engine_dir})")
