  ...
  describe "AuthorsOverlay component", ->
    ...
    describe "#componentWillReceiveProps", ->
      it "sets state.authors to props.authors", ->
        ...
        component = Tahi.overlays.standardsAuthors.Overlay authors: authors
  ...
  describe "AuthorDetailsForm component", ->
    describe "#handleSubmit", ->
      beforeEach ->
        ...
        @component = Tahi.overlays.standardsAuthors.AuthorDetailsForm
          key: 134
          author: {}
