...
creator_login27 = {'user': 'aauthor24',
                   'name': 'atest author24',
                   'initials': 'aa24',
                   'email': 'sealresq+1039@gmail.com',
                   'orcidid': '0000-0003-0311-177X',
                   'profile_image': '',
                   'affiliation-name': 'PLOS',
                   'affiliation-dept': '',
                   'affiliation-title': '',
...
creator_login28 = {'user': 'aauthor25',
                   'name': 'atest author25',
                   'initials': 'aa25',
                   'email': 'sealresq+1040@gmail.com',
                   'orcidid': '0000-0002-1775-5990',
                   'profile_image': '',
                   'affiliation-name': 'PLOS',
                   'affiliation-dept': '',
                   'affiliation-title': '',
...
docs = \
    ['frontend/assets/docs/A_Systematic_Review_and_Meta-analysis_of_the_Efficacy_and_Safety_of_'
     ...
     'systems.doc',
     'frontend/assets/docs/Aedes_hensilli_as_a_Potential_Vector_of_Chikungunya_and_Zika_'
     'Viruses.doc',
     ...
     'frontend/assets/docs/Schmallenberg_Virus_Pathogenesis_Tropism_and_Interaction_With_the_'
     'Innate_Immune_.doc',
     'frontend/assets/docs/Serological_Evidence_of_Ebola_Virus_Infection_in_Indonesian_'
     'Orangutans.doc',
     'frontend/assets/docs/Synergistic_Parasite-Pathogen_Interactions_Mediated_by_Host_Immunity_'
     'Can_Drive_the_.doc',
     ...
     'frontend/assets/docs/The_eyes_dont_have_it_Lie_detection_and_Neuro-Linguistic_'
     'Programming.doc',
     'frontend/assets/docs/Twelve_years_of_rabies_surveillance_in_Sri_Lanka_1999-2010.doc',
     'frontend/assets/docs/Vaccinia_Virus_Protein_C6_is_a_Virulence_Factor_that_Binds_TBK-1_'
     'Adaptor_Proteins_.doc',
...
docxs = \
    ['frontend/assets/docs/ANATOMICAL_BRAIN_IMAGES_ALONE_CAN_ACCURATELY_DIAGNOSE_NEUROPSYCHIATRIC_'
     ...
     'with_.docx',
     'frontend/assets/docs/Abundance_of_commercially_important_reef_fish_indicates_different_'
     'levels_of_.docx',
     ...
     'Netrin-1_.docx',
     'frontend/assets/docs/Evidence_of_a_bacterial_receptor_for_lysozyme_Binding_of_lysozyme_to_'
     'the_anti-.docx',
     ...
     'frontend/assets/docs/Fecal_contamination_of_drinking-water_in_low_and_middle-income_'
     'countries_a_.docx',
     ...
     'frontend/assets/docs/Social_network_analysis_shows_direct_evidence_for_social_transmission_'
     'of_tool_use_.docx',
...
pdfs = \
    [
        ...
        'NEUROPSYCHIATRIC_ILLNESSES.pdf',
        'frontend/assets/pdfs/A_Division_in_PIN-Mediated_Auxin_Patterning_During_Organ_'
        'Initiation_in_Grasses.pdf',
        ...
        'frontend/assets/pdfs/Abnormal_Contextual_Modulation_of_Visual_Contour_Detection_in_'
        'Patients_with_.pdf',
        'frontend/assets/pdfs/Abundance_of_commercially_important_reef_fish_indicates_different_'
        'levels_of_.pdf',
        'frontend/assets/pdfs/Actin_turnover_in_lamellipodial_fragments.pdf',
        'frontend/assets/pdfs/Acupuncture_and_Counselling_for_Depression_in_Primary_Care_a_'
        'Randomised_Controlled.pdf',
        'frontend/assets/pdfs/Adaptation_to_Temporally_Fluctuating_Environments_by_the_'
        'Evolution_of_Maternal_.pdf',
        'frontend/assets/pdfs/Aedes_hensilli_as_a_Potential_Vector_of_Chikungunya_and_Zika_'
        'Viruses.pdf',
        ...
        'frontend/assets/pdfs/Chikungunya_Disease_Infection-Associated_Markers_from_the_Acute_'
        'to_the_Chronic_Phase_.pdf',
        'frontend/assets/pdfs/Chromosome_X-wide_association_study_identifies_loci_for_fasting_'
        'insulin_and_height_.pdf',
        ...
        'through_.pdf',
        'frontend/assets/pdfs/Correction_Macrophage_Control_of_Phagocytosed_Mycobacteria_Is_'
        'Increased_by_Factors_.pdf',
        ...
        'During_.doc',
        'frontend/assets/pdfs/Effect_of_Heterogeneous_Investments_on_the_Evolution_of_'
        'Cooperation_in_Spatial_.pdf',
        'frontend/assets/pdfs/Epidermal_Growth_Factor_Receptor-dependent_Mutual_Amplification_'
        'between_Netrin-1_.pdf',
        'frontend/assets/pdfs/Evidence_of_a_bacterial_receptor_for_lysozyme_Binding_of_lysozyme_'
        'to_the_anti-_.pdf',
        ...
        'frontend/assets/pdfs/Gene_expression_signature_predicts_human_islet_integrity_and_'
        'transplant_functionality.pdf',
        ...
        'System_for_.pdf',
        'frontend/assets/pdfs/Honing_the_Priorities_and_Making_the_Investment_Case_for_Global_'
        'Health.pdf',
        ...
        '1990_progress_.pdf',
        'frontend/assets/pdfs/Neural_phase_locking_predicts_BOLD_response_in_human_auditory_'
        'cortex.pdf',
        'frontend/assets/pdfs/New_material_of_Beelzebufo_a_hyperossified-frog_Amphibia_Anura_'
        'from_the_Late-.pdf',
        'frontend/assets/pdfs/OVARIAN_CANCER_AND_BODY_SIZE.pdf',
        'frontend/assets/pdfs/Parallel_evolution_of_HIV-1_in_a_long-term_experiment-with_caption_'
        'style_removed.pdf',
        'frontend/assets/pdfs/Polymorphisms_in_genes_involved_in_the_NF-KB_signalling_pathway_are_'
        'associated_with_.pdf',
        'frontend/assets/pdfs/Potential_role_of_M._tuberculosis_specific_IFN-_and_IL-2_ELISPOT_'
        'assays_in_.pdf',
        'frontend/assets/pdfs/Preclinical_Applications_of_3-Deoxy-3-18F_Fluorothymidine_in_'
        'Oncology-A_Systematic_.pdf',
        'frontend/assets/pdfs/Probing_the_anti-obesity_effect_of_grape_seed_extracts_reveals_that_'
        'purified_.pdf',
        'frontend/assets/pdfs/Promoter_sequence_determines_the_relationship_between_expression_'
        'level_and_noise.pdf',
        'frontend/assets/pdfs/Protonic_Faraday_cage_effect_of_cell_envelopes_protects_'
        'microorganisms_from_.pdf',
        'frontend/assets/pdfs/Rare_species_support_semi-vulnerable_functions_in_high-diversity_'
        'ecosystems.pdf',
        'frontend/assets/pdfs/Rare_species_support_semi-vulnerable_functions_in_high-diversity_'
        'ecosystems_edited.pdf',
        'frontend/assets/pdfs/Reduction_of_the_Cholesterol_Sensor_SCAP_in_the_Brains_of_Mice_'
        'Causes_Impaired_.pdf',
        ...
        'frontend/assets/pdfs/Retraction_Polymorphism_of_9p21.3_Locus_Associated_with_5-Year_'
        'Survival_in_High-.pdf',
        'frontend/assets/pdfs/Retraction_Polymorphism_of_9p21.3_Locus_Associated_with_5-Year_'
        'Survival_in_edited.pdf',
        'frontend/assets/pdfs/Rnf165_Ark2C_Enhances_BMP-Smad_Signaling_to_Mediate_Motor_Axon_'
        'Extension.pdf',
        'frontend/assets/pdfs/Schmallenberg_Virus_Pathogenesis_Tropism_and_Interaction_With_the_'
        'Innate_Immune_.pdf',
        'frontend/assets/pdfs/Scientific_Prescription_to_Avoid_Dangerous_Climate_Change_to_Protect_'
        'Young_People_.pdf',
        'frontend/assets/pdfs/Serological_Evidence_of_Ebola_Virus_Infection_in_Indonesian_'
        'Orangutans.pdf',
        ...
        'observation_of_.pdf',
        'frontend/assets/pdfs/Social_network_analysis_shows_direct_evidence_for_social_'
        'transmission_of_tool_use_.pdf',
        ...
        'frontend/assets/pdfs/Synergistic_Parasite-Pathogen_Interactions_Mediated_by_Host_'
        'Immunity_Can_Drive_the_.pdf',
        'frontend/assets/pdfs/TOLL-LIKE_RECEPTOR_8_AGONIST_AND_BACTERIA_TRIGGER_POTENT_'
        'ACTIVATION_OF_INNATE_.pdf',
        ...
        'frontend/assets/pdfs/The_Epidermal_Growth_Factor_Receptor_Critically_Regulates_'
        'Endometrial_Function_.pdf',
        'frontend/assets/pdfs/The_Impact_of_Psychological_Stress_on_Mens_Judgements_of_Female_'
        'Body_Size.pdf',
        ...
        'oxygen.pdf',
        'frontend/assets/pdfs/The_eyes_dont_have_it_Lie_detection_and_Neuro-Linguistic_'
        'Programming.pdf',
        'frontend/assets/pdfs/The_internal_organization_of_the_mycobacterial_partition_assembly_'
        'does_the_DNA_wrap_.pdf',
        ...
        'frontend/assets/pdfs/Ubiquitin-mediated_response_to_microsporidia_and_virus_'
        'infection_in-C._elegans.pdf',
        'frontend/assets/pdfs/Uncovering_Treatment_Burden_As_A_Key_Concept_For_Stroke_Care_A_'
        'Systematic_Review_of_.pdf',
        'frontend/assets/pdfs/Vaccinia_Virus_Protein_C6_is_a_Virulence_Factor_that_Binds_TBK-1_'
        'Adaptor_Proteins_.pdf',
...
gen_cmplt_apexdata = {'name': 'generateCompleteApexData',
                      'user_tasks': ['Additional Information', 'Authors', 'Billing',
                                     ...
                                     'Early Version', 'Ethics Statement', 'Figures',
...
sim_check_full_submission_mmt = {'name': 'Similarity Check test on full submission',
                                 'user_tasks': ['Upload Manuscript'],
                                 'staff_tasks': ['Assign Team', 'Editor Discussion',
                                                 'Final Tech Check',
                                                 'Invite Academic Editor', 'Invite Reviewers',
                                                 'Production Metadata', 'Register Decision',
                                                 'Related Articles', 'Revision Tech Check',
...
sim_check_major_revision_mmt = {'name': 'Similarity Check test on major revision',
                                'user_tasks': ['Upload Manuscript'],
                                'staff_tasks': ['Assign Team', 'Editor Discussion',
                                                'Final Tech Check',
                                                'Invite Academic Editor', 'Invite Reviewers',
...
sim_check_minor_revision_mmt = {'name': 'Similarity Check test on minor revision',
                                'user_tasks': ['Upload Manuscript'],
                                'staff_tasks': ['Assign Team', 'Editor Discussion',
                                                'Final Tech Check',
                                                'Invite Academic Editor', 'Invite Reviewers',
...
sim_check_first_revision_mmt = {'name': 'Similarity Check test on first revision',
                                'user_tasks': ['Upload Manuscript'],
                                'staff_tasks': ['Assign Team', 'Editor Discussion',
                                                'Final Tech Check',
                                                'Invite Academic Editor', 'Invite Reviewers',
...
bio_essay = {'name': 'Essay',
             'user_tasks': ['Competing Interests', 'Cover Letter', 'Upload Manuscript', 'Authors',
                            ...
                            'Additional Information', 'Early Version'],
...
bio_commpage = {'name': 'Community Page',
                'user_tasks': ['Competing Interests', 'Cover Letter', 'Upload Manuscript',
                               'Authors',
                               'Ethics Statement', 'Figures', 'Reviewer Candidates',
                               'Supporting Info', 'Financial Disclosure',
                               'Additional Information', 'Early Version'],
...
bio_nwc = {'name': 'New Workflow Concept',
           'user_tasks': ['Upload Manuscript', 'Supporting Info', 'Competing Interests',
                          'Cover Letter',
                          'Additional Information', 'Reviewer Candidates', 'Figures',
                          'Authors', 'Ethics Statement', 'Data Availability',
                          'Financial Disclosure', 'Early Version'],
