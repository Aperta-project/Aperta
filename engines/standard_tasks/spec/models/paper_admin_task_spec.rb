    ...
    describe "after_save" do
      ...
      context "when the assignee is not changing" do
        it "does not modify other tasks" do
          paper_admin_task = StandardTasks::PaperAdminTask.create! assignee: bob, phase: phase
      ...
      context "when there are admin tasks with no assignee" do
        ...
        it "assigns the task to the StandardTasks::PaperAdminTask assignee" do
          StandardTasks::PaperAdminTask.create! assignee: bob, phase: phase
          expect(task.reload.assignee).to eq(bob)
        end
      end

      context "when there are admin tasks with the old assignee" do
        let!(:paper_admin_task) { StandardTasks::PaperAdminTask.create! assignee: bob, phase: phase }
      ...
      context "when there are admin tasks assigned to another admin" do
        ...
        it "does not assign the task to the StandardTasks::PaperAdminTask assignee" do
      ...
      describe "tasks in other phases in the same task manager" do
        ...
        let(:paper_admin_task) { StandardTasks::PaperAdminTask.create! phase: reading_phase }
