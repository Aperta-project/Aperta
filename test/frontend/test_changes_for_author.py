...
class CFACardTest(CommonTest):
    ...
    def test_smoke_cfa_from_itc_card(self):
        ...
        self.create_article(title='Test Changes for Author from ITC card',
                            journal='PLOS Wombat', type_='NoCards', random_bit=True)
        ...
        cfa_task.click_completion_button()
        manuscript_page.click_submit_btn()
        manuscript_page.confirm_submit_btn()
        manuscript_page.close_modal()
    ...
    def test_smoke_cfa_from_rtc_card(self):
        ...
        dashboard_page.page_ready()
        dashboard_page.click_create_new_submission_button()
        self.create_article(title='Test Changes for Author from RTC card',
                            journal='PLOS Wombat', type_='NoCards', random_bit=True)
        manuscript_page = ManuscriptViewerPage(self.getDriver())
        manuscript_page.page_ready_post_create()
        paper_id = manuscript_page.get_paper_short_doi_from_url()
    ...
    def test_smoke_cfa_from_ftc_card(self):
        ...
        dashboard_page.page_ready()
        dashboard_page.click_create_new_submission_button()
        self.create_article(title='Test Changes for Author from FTC card',
                            journal='PLOS Wombat', type_='NoCards', random_bit=True)
        manuscript_page = ManuscriptViewerPage(self.getDriver())
        manuscript_page.page_ready_post_create()
        paper_id = manuscript_page.get_paper_short_doi_from_url()
