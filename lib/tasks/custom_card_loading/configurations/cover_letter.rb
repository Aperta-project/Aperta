        ...
        <card required-for-submission="false" workflow-display-only="false">
          <content content-type="display-children">
            ...
            <content content-type="text">
              ...
              <li>What other novel findings do you preseddddnt?</li>
            ...
            <content content-type="file-uploader" value-type="attachment" allow-multiple-uploads="true" allow-file-captions="true">
