...
class PreprintPostingOverlay(AuthenticatedPage):
    ...
    def validate_styles(self):
        ...
        expected_background_image = '/assets/preprint-sample-488992c533d61c7c2296749809a9ba' \
                                    '170516a74b81025d39a1ea45d8d896a726.png'
        ...
        expected_yes_radio_label = 'Yes, I want to accelerate research by publishing a preprint ' \
                                   'ahead of peer review'
        expected_no_radio_label = 'No, I do not want my article to appear online ahead of the ' \
                                  'reviewed article'
    ...
    def select_preprint_overlay_in_create_sequence_and_continue(self, selection=''):
        ...
        no_radio = radio_buttons[1]
        if not selection:
            # not sure what we expect out of the gate, but I am putting my finger a little bit on
            # the side of a No selection - need to validate with business intelligence
        ...
        if selection.lower() == 'yes':
            ...
            raise (ValueError, 'Invalid selection for Preprint opt-in choice: '
                               '{0}'.format(selection))
        continue_button = self._get(self._preprint_overlay_continue_btn)
