...
class FigureTaskTest(CommonTest):
    ...
    def test_core_figures_task_replace(self):
        ...
        # Need to allot a good amount of time here for figure upload, storage and thumbnail
        #     processing. Have had rare failures at 22s
        time.sleep(25)
        figures_list = \
            figures_task.replace_figure(
                figure2replace='figure1_tiff_lzw.tiff',
    ...
    def test_core_figures_task_delete(self):
        ...
        figures_task._wait_for_text_be_present_in_element(figures_task._figure_dl_link,
                                                          figures_list[0])
    ...
    def test_core_figures_task_download(self):
        ...
        figures_list = figures_task.upload_figure()
        # Need to allot a good amount of time here for figure upload, storage and thumbnail
        #     processing. Have had rare failures at 20s
        time.sleep(22)
