...
class AssignTeamCard(BaseCard):
    ...
    def validate_card_elements_styles(self, short_doi):
        ...
        :param short_doi: short_doi of paper for passing through to
            validate_common_elements_styles()
    ...
    def assign_role(self, person, role):
        ...
        self._wait_for_text_be_present_in_element(self.assign_team_role_selector,
                                                  'Please select Role')
