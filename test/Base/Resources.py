...
bio_nwc = {'name':               'New Workflow Concept',
           'user_tasks':         ['Upload Manuscript', 'Supporting Info', 'Competing Interests', 'Cover Letter',
...
gen_persp = {'name':               'Perspective',
             'user_tasks':         ['Competing Interests', 'Cover Letter', 'Upload Manuscript', 'Authors', 'Figures',
                                    'Supporting Info', 'Financial Disclosure',
                                    'Additional Information', 'Early Version'],
             'staff_tasks':        ['Initial Tech Check', 'Revision Tech Check', 'Final Tech Check',
