...
ve.ce.FocusableNode.prototype.executeCommand = function () {
	...
	command = this.focusableSurface.getSurface().getCommandRegistry().getCommandForNode( this );
	if ( command ) {
...
ve.ce.Surface.prototype.pasteIntoTable = function ( tableNode, clipboardData ) {
	...
	tx = ve.dm.Transaction.newFromReplacement( this.documentView.model,
		tableNode.getRange(), pastedTableData );
...
ve.ce.Surface.prototype.checkSequences = function () {
	...
	sequences = this.getSurface().getSequenceRegistry().findMatching( model.getDocument().data, selection.getRange().end );
 ...
 *
 * @constructor
 * @param {ve.dm.Surface} surfaceModel The model instance
 * @param {ve.ui.CommandRegistry} commandRegistry The command registry
 * @param {ve.ui.SequenceRegistry} sequenceRegistry The sequence registry
 * @param {Object} [config] Configuration options
 ...
 */
ve.ui.Surface = function VeUiSurface( surfaceModel, commandRegistry, sequenceRegistry, config ) {
	var documentModel;
	...
	this.triggerListener = new ve.TriggerListener( OO.simpleArrayDifference(
		config.includeCommands || Object.keys( commandRegistry.registry ), config.excludeCommands || []
	), commandRegistry );
 ...
 *
 * @return {ve.ui.CommandRegistry} The command registry
 */
ve.ui.Surface.prototype.getCommandRegistry = function () {
 ...
 *
 * @return {ve.ui.SequenceRegistry} The sequence registry
 */
ve.ui.Surface.prototype.getSequenceRegistry = function () {
...
ve.ui.ContextItem.prototype.getCommand = function () {
	return this.context.getSurface().getCommandRegistry().lookup( this.constructor.static.commandName );
};
...
ve.ui.ToolContextItem.prototype.getCommand = function () {
	return this.context.getSurface().getCommandRegistry().lookup( this.tool.static.commandName );
};
...
ve.ui.Sequence.prototype.execute = function ( surface, range ) {
	var stripRange, executed, stripFragment, selection,
		...
		command = surface.getCommandRegistry().lookup( this.getCommandName() );
