...
describe StandardTasks::PaperReviewerTaskPresenter do
  ...
  describe "#data_attributes" do
    ...
    let(:task) do
      ...
      paper = Paper.create! title: "Foo bar",
        ...
        user: author
      task = StandardTasks::PaperReviewerTask.create! completed: true,
    ...
    subject(:data_attributes) { StandardTasks::PaperReviewerTaskPresenter.new(task).data_attributes }

    it_behaves_like "all tasks, which have common attributes" do
      let(:card_name) { 'standards-paper-reviewer' }
