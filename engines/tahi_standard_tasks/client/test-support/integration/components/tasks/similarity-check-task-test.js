...
moduleForComponent(
  ...
  'Integration | Component | Tasks | similarity_check_task', {
    integration: true
  });
...
var newTask = function (){
  return {
    id: 2,
    title: 'similarity-check-task',
    type: 'similarity-check-task',
    completed: false,
...
var template = hbs`{{similarity-check-task task=task can=can}}`;
