...
# -*- coding: utf-8 -*-
"""
This test case that populates all mmt needed for python test suite runs. Note that normally,
the population of biology and genetics demo journals is disabled via changing the test method name
from test_* to rest_*.
These only need to be run in demo, so it is appropriate to leave them in place and disabled.
"""
...
from Base.Resources import super_admin_login, no_cards_mmt, gen_cmplt_apexdata, imgs_init_dec_mmt, \
    ...
    pp_optin_mmt, \
    pp_authors_mmt, bio_essay, bio_resart, bio_genres, bio_mystery, bio_commpage, bio_formcomm, \
    bio_nwc, gen_resart, \
    gen_persp, pp_card_mmt, sim_check_off_mmt, sim_check_full_submission_mmt, \
    sim_check_major_revision_mmt, \
...
class ApertaSeedJournalMMTTest(CommonTest):
          ...
          journal:
            - NoCards
              ...
              staffcards: Assign Team, Editor Discussion, Final Tech Check, Invite Academic Editor,
                          Invite Reviewers, Production Metadata, Register Decision,
            ...
            - generateCompleteApexData
              usercards:  Additional Information, Authors, Billing, Competing Interests,
                          Cover Letter, Data Availability, Ethics Statement, Figures,
                          Financial Disclosure, New Taxon, Reporting Guidelines,
            ...
            - Research
              ...
              useresearchreviewerreport: True
            - Front-Matter-type
              usercards:  Additional Information, Authors, Figures, Supporting Info,
                          Upload Manuscript
              staffcards: Invite Reviewers, Production Metadata, Register Decision,
                          Related Articles, Send to Apex, Title And Abstract
          ...
          journal:
            ...
            - Research Article
              ...
              staffcards: Assign Team, Initial Decision, Invite Academic Editor, Title And Abstract,
                          ...
                          Register Decision
                          Production Metadata,
                          Ad hoc for Staff Only (named Copyedit - INTERNAL USE),
            ...
            - Genetics Research
              usercards:  Additional Information, Authors, Billing, Competing Interests,
                          Cover Letter, Data Availability, Ethics Statement, Figures,
                          Financial Disclosure, Reporting Guidelines, Reveiwer Candidates,
                          Supporting Info, Upload Manuscript
              staffcards: Initial Tech Check, Revision Tech Check, Final Tech Check,
                          Assign Team, Invite Academic Editor,
                          Invite Reviewers,
    ...
    def test_populate_base_mmts(self):
        ...
        qa_mmts = [only_init_dec_mmt, only_rev_cands_mmt, gen_cmplt_apexdata, front_matter_mmt,
                   no_cards_mmt,
                   imgs_init_dec_mmt, resrch_w_init_dec, research_mmt, pp_optin_mmt, pp_authors_mmt,
                   pp_card_mmt,
        ...
        for mmt in qa_mmts:
            ...
            if not mmt_present:
                ...
                # It is necessary to reinvoke the driver to avoid a Stale Element Reference
                #   Exception as each new mmt add updates the DOM
                adm_wf_page = AdminWorkflowsPage(self.getDriver())
    ...
    def rest_populate_biology_demo_mmts(self):
        ...
        :return: void function
        """
        bio_mmts = [bio_essay, bio_resart, bio_genres, bio_mystery, bio_formcomm, bio_commpage,
                    bio_nwc]
        ...
        for mmt in bio_mmts:
            ...
            if not mmt_present:
                ...
                adm_wf_page.add_new_mmt_template(commit=True,
                                                 ...
                                                 uses_resrev_report=mmt['uses_resrev_report'],
                                                 preprint_eligible=mmt['preprint_eligible'])
                # It is necessary to reinvoke the driver to avoid a Stale Element
                #   Reference Exception as each new mmt add updates the DOM
                adm_wf_page = AdminWorkflowsPage(self.getDriver())
