...
class ReviewerReportTest(CommonTest):
    ...
    def test_core_rev_rep_non_research_actions(self):
        """
        test_reviewer_report: Validates the elements, styles, roles and functions of the
    ...
    def test_core_rev_rep_research_actions(self):
        ...
        if validate_view_in_place:
            ...
            found = workflow_page.click_card('review_by',
                                             'Review by {0} (#1)'.format(reviewer_name))
            if not found:
