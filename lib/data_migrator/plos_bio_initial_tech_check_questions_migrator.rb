class DataMigrator::PlosBioInitialTechCheckQuestionsMigrator < DataMigrator::Base
  ...
  IDENTS = {
    old: {
      OPEN_REJECTS_IDENT: "initial_tech_check.open_rejects",
      HUMAN_SUBJECTS_IDENT: "initial_tech_check.human_subjects",
      ETHICS_NEEDED_IDENT: "initial_tech_check.ethics_needed",
      DATA_AVAILABLE_IDENT: "initial_tech_check.data_available",
      SUPPORTING_INFORMATION_IDENT: "initial_tech_check.supporting_information",
      DRYAD_URL_IDENT: "initial_tech_check.dryad_url",
      FINANCIAL_DISCLOSURE_IDENT: "initial_tech_check.financial_disclosure",
      TOBACCO_IDENT: "initial_tech_check.tobacco",
      FIGURES_LEGIBLE_IDENT: "initial_tech_check.figures_legible",
      CITED_IDENT: "initial_tech_check.cited",
      COVER_LETTER_IDENT: "initial_tech_check.cover_letter",
      BILLING_INQUIRIES_IDENT: "initial_tech_check.billing_inquiries",
      ETHICS_STATEMENT_IDENT: "initial_tech_check.ethics_statement"
    },
