...
docs = ['10yearsRabiesSL20140723.doc',
        ...
        'Article_RJ_FINAL.docx',
        'Banisch_Final.docx',
        'C6_Text_Final.doc',
        'CRX.pone.0103411.docx',
        'Carey_vanDijk__Final.doc',
        'Chemical_Synthesis_of_Bacteriophage_G4.doc',
        'Dirnagl_2BLabCIRS_2Bmanuscript_2Bfinal_2Bfor_2Baperta_2BR1_AA_20161006.docx',
        'EGFR_PLOS_GENETICS.docx',
        'Final_version_PLOS_Biology_SCAP_manuscript.doc',
        ...
        'Jouffe_et_al-R2.doc',
        'Jouffe_et_al_clean_copy-R5.docx',
        ...
        'PLOS_A_case_for_investing_in_Global_Health_resubmission_vvfinal.docx',
        ...
        'PNTD-D-12-00578_Revised_manuscript_Final_5.9.2012.doc',
        ...
        'UserTest4_MS_File.docx',
        'UserTest4_MS_File_2.docx',
        'UserTest4_MS_File_3.docx',
        'UserTesting3_MS_File.docx',
        'UserTesting3_MS_File_2.docx',
        'User_Testing3_MS_File_3.docx',
        ...
        'ridiculously_large.docx',
        'sample.docx',
        'tbParBSASpl1.docx',
        'wordcaptionstyletest.docx'
        ]
