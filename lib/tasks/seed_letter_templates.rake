  ...
  namespace :letter_templates do
    ...
    task populate: :environment do
      Journal.all.each do |journal|
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'editor-decision-reject-after-review')
          LetterTemplate.where(name: 'Editor Decision - Reject After Review', category: 'reject', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'editor-decision-reject-after-review'
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'editor-decision-reject-after-review-cjs')
          LetterTemplate.where(name: 'Editor Decision - Reject After Review CJs', category: 'reject', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'editor-decision-reject-after-review-cjs'
            lt.scenario = 'TahiStandardTasks::RegisterDecisionScenario'
            lt.subject = 'Your {{ journal.name }} submission'
            lt.to = author_emails
            lt.body = <<-TEXT.strip_heredoc
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'editor-decision-reject-after-review-one')
          LetterTemplate.where(name: 'Editor Decision - Reject After Review ONE', category: 'reject', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'editor-decision-reject-after-review-one'
            lt.scenario = 'TahiStandardTasks::RegisterDecisionScenario'
            lt.subject = 'Your {{ journal.name }} submission'
            lt.to = author_emails
            lt.body = <<-TEXT.strip_heredoc
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'reject-after-revision-and-re-review-one')
          LetterTemplate.where(name: 'Reject After Revision and Re-review ONE', category: 'reject', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'reject-after-revision-and-re-review-one'
            lt.scenario = 'TahiStandardTasks::RegisterDecisionScenario'
            lt.subject = 'Your {{ journal.name }} submission'
            lt.to = author_emails
            lt.body = <<-TEXT.strip_heredoc
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'ra-accept')
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'review-reminder-before-due')
          LetterTemplate.where(name: 'Review Reminder - Before Due', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'review-reminder-before-due'
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'review-reminder-first-late')
          LetterTemplate.where(name: 'Review Reminder - First Late', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'review-reminder-first-late'
            lt.scenario = 'ReviewerReportScenario'
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'review-reminder-second-late')
          LetterTemplate.where(name: 'Review Reminder - Second Late', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'review-reminder-second-late'
            lt.scenario = 'ReviewerReportScenario'
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'reviewer-appreciation')
          LetterTemplate.where(name: 'Reviewer Appreciation', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'reviewer-appreciation'
            lt.scenario = 'ReviewerReportScenario'
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'preprint-accept')
          LetterTemplate.where(name: 'Preprint Accept', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'preprint-accept'
        ...
        # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        unless LetterTemplate.exists?(journal: journal, ident: 'preprint-reject')
          LetterTemplate.where(name: 'Preprint Reject', journal: journal).first_or_initialize.tap do |lt|
            lt.ident = 'preprint-reject'
            lt.scenario = 'TahiStandardTasks::PreprintDecisionScenario'
